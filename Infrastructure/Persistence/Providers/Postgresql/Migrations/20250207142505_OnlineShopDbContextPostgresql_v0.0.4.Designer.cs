...
namespace OnlineShop.Infrastructure.Persistence.Providers.Postgresql.Migrations
{
    ...
    [Migration("20250207142505_OnlineShopDbContextPostgresql_v0.0.4")]
    partial class OnlineShopDbContextPostgresql_v004
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ItemEntity", b =>
                {
                    b.HasOne("Domain.Entities.BasketEntity", "Basket")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_BasketEntity_ItemEntity");

                    b.HasOne("OnlineShop.Domain.Entities.TypeEntity", "Types")
                        .WithMany()
